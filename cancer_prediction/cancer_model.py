...
class CancerModel:
    ...
    def fit(self, X: np.ndarray | pd.DataFrame, y: np.ndarray | pd.DataFrame) -> None:  # type hints
    ...
    def get_feature_importance_df_sorted_by_variance_and_variance(self, X: np.ndarray) -> np.ndarray:
        """_summary_
